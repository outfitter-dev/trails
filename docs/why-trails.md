...
- **Observed:** Learned from runtime (future) — error distributions, latency profiles, service usage patterns from the crumbs system. Observations close the loop between declared intent and actual behavior.
