...
- **Surface rendering** — no draft trails in current shipped surfaces
- **Lockfile export** — no draft nodes in an app root's `trails.lock`
- **OpenAPI generation** — the HTTP OpenAPI rendering excludes draft trails
