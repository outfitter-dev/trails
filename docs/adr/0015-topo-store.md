...
[^surface-map]: The surface map is generated by `deriveSurfaceMap()` in `@ontrails/topographer` and written to `.trails/_surface.json` by `writeSurfaceMap()`. See `packages/topographer/src/io.ts`.
