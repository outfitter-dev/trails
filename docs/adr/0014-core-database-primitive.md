...
[^surface-map]: The surface map is generated by `deriveSurfaceMap()` in `@ontrails/topographer` and written to `.trails/_surface.json` by `writeSurfaceMap()`. See [ADR-0008: Deterministic Surface Derivation](0008-deterministic-trailhead-derivation.md).
