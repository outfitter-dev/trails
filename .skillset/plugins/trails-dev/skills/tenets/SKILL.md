...
For deeper architectural judgment, vocabulary enforcement, or a challenge to a tenet itself, use the target checkout's documented decision workflow and cite the governing source.
