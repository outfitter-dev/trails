...
Use the canonical [Homebrew installation guide](../../docs/getting-started.md#installation) for installation, updates, and removal. The tap provides Trails `0.2.0` and requires Bun at runtime.
