...
- [`bb81ffe`](https://github.com/outfitter-dev/trails/commit/bb81ffe902364ee95c4ddd317ffb111862a8350f): Resolve declared adapter owner imports through wildcard package export keys
...
- [`4f43874`](https://github.com/outfitter-dev/trails/commit/4f438745a4f78cfe4b4fcc2b09e542230ec2ff4d): Add the shared adapter readiness check engine for authoring and review workflows.
...
- [`3caa263`](https://github.com/outfitter-dev/trails/commit/3caa263f699a0a2794e28cfd3f83442faf8cd6de): Add adapter fact projections to the shared adapter readiness report so downstream tooling can distinguish available targets, configured adapter packages, and conformance-backed usage evidence.
