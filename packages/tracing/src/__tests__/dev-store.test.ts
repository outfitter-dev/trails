...
const LEGACY_CREATE_TABLE_SQL = `CREATE TABLE IF NOT EXISTS tracing (
  id TEXT PRIMARY KEY,
...
const LEGACY_UPSERT_SQL = `INSERT INTO tracing (
...
const writeLegacyTrackerDb = (
  ...
  const path = join(rootDir, '.trails', 'dev', 'tracing.db');
