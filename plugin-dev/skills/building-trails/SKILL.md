...
- Architectural judgment, vocabulary rulings, and tenet questions: use the target checkout's documented decision workflow.
- Execution shape, stacks, runs, and review loops: use the target checkout's documented delivery workflow.
